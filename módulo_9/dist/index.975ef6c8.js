...
})({"jysqb":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
_dataBusiness.getCharacters().then((characters)=>{
    const nodes = [];
    for (let character of characters){
        const node = _utils.createCharacterRow(character);
        node.onclick = function() {
            _dataBusiness.getTypeCharacters(character.char_id).then((charactersId)=>{
                _utils.showCharacter(charactersId);
            });
        };
        nodes.push(node);
    }
...
},{"./data-business":"iM7Bx","./utils":"en4he","./styles.css":"lW6qc"}],"iM7Bx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCharacters", ()=>getCharacters
);
parcelHelpers.export(exports, "getTypeCharacters", ()=>getTypeCharacters
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"f70jQ"}],"f70jQ":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"f70jQ"}],"lW6qc":[function() {},{}]},["jysqb","8lqZg"], "8lqZg", "parcelRequire94c2")
